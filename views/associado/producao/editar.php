    ...
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-edit"></i>  Produção</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
    <div class="row">
        ...
        <div class="col-md-12 clear">
            <form method="POST" autocomplete="off">
                <input type="hidden" name="nCodHistorico" value="<?php echo!empty($associado['cod']) ? $associado['cod'] : '' ?>"/>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                                ...
                                <select name="nProducao" id="iProducao" class="form-control select2-js">
                                    ...
                                    if (isset($producao) && !empty($producao)) {
                                        foreach ($producao as $index) {
                                            if (isset($associado['producao_cod']) && !empty($associado['producao_cod']) && $associado['producao_cod'] == $index['cod']) {
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="nArea" id="iarea" class="form-control" value="<?php echo!empty($associado['area']) ? $associado['area'] : '' ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
