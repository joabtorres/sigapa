    ...
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="text-uppercase"><a href="<?php echo BASE_URL ?>/cooperado/index/<?php echo!empty($cooperado['historico']['associado_cod']) ? $cooperado['historico']['associado_cod'] : '' ?>"><i class="fa fa-user"></i> <?php echo!empty($cooperado['historico']['nome_completo']) ? $cooperado['historico']['nome_completo'] : '' ?></a></li>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="icadUnidade">Cooperado: </label>
                                <input type="hidden" name="nCodCooperado" value="<?php echo!empty($cooperado['historico']['associado_cod']) ? $cooperado['historico']['associado_cod'] : '' ?>"/>
