    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel panel-black">
                <div class="panel-heading">
                    <div class="row">
                        <a href="<?php echo BASE_URL ?>/operacao/carteira/<?php echo!empty($cooperado['cooperado']['cod']) ? $cooperado['cooperado']['cod'] : '' ?>" target="_blank">
                            <div class="col-xs-12">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="row">
                        <a href="<?php echo BASE_URL ?>/operacao/recibo/<?php echo!empty($cooperado['cooperado']['cod']) ? $cooperado['cooperado']['cod'] : '' ?>" target="_blank" >
                            <div class="col-xs-12">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <div class="row">
                        <a href="<?php echo BASE_URL ?>/operacao/recibo_mensalidade/<?php echo!empty($cooperado['cooperado']['cod']) ? $cooperado['cooperado']['cod'] : '' ?>" target="_blank">
                            <div class="col-xs-12">
                                <i class="fa fa-clipboard-list fa-3x pull-left"></i>                               
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel panel-black">
                <div class="panel-heading">
                    <div class="row">
                        <a href="<?php echo BASE_URL ?>/operacao/cartao_visita/<?php echo!empty($cooperado['cooperado']['cod']) ? $cooperado['cooperado']['cod'] : '' ?>" target="_blank">
                            <div class="col-xs-12">
                                <i class="fa fa-address-card fa-3x pull-left" ></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3 ">
                                    <p><span class="text-destaque">Nº DO CAR:</span> <?php echo!empty($cooperado['cooperado']['genero']) ? $cooperado['cooperado']['car'] : '' ?></p>
                                </div>
                                <div class="col-sm-6 col-md-3 ">
                                    <p><span class="text-destaque">Nº DO DAP:</span> <?php echo!empty($cooperado['cooperado']['genero']) ? $cooperado['cooperado']['dap'] : '' ?></p>
                                </div>
                            </div>
                            <!--fim row-->
                            <!--inicio row-->
        ...
        <div class="col-md-12 clear">
            <section class="panel panel-black">
                ...
                <article class="panel-body">
                    <span class="pull-right"><a href="<?php echo BASE_URL . '/cadastrar/mensalidade/' . $cooperado['cooperado']['cod'] ?>" class="btn btn-sm btn-warning" title="Adicionar Mensalidade"><i class="fa fa-plus-circle"></i> Adicionar</a></span>
                </article>
                <article class="table-responsive">
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        <tr>
        ...
        <div class="col-md-12 clear">
            <section class="panel panel-black">
                ...
                <article class="panel-body">
                    <span class="pull-right"><a href="<?php echo BASE_URL . '/cadastrar/historico/' . $cooperado['cooperado']['cod'] ?>" class="btn btn-sm btn-warning" title="Adicionar Histórico"><i class="fa fa-plus-circle"></i> Adicionar</a></span>
                </article>
                <article class="table-responsive">
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        <tr>
            ...
            <article class="modal-dialog modal-md" role="document">
                <section class="modal-content">
                    ...
                    <footer class="modal-footer">
                        <a class="btn btn-danger pull-left" href="<?php echo BASE_URL . '/excluir/mensalidade/' . $cooperado['cooperado']['cod'] . '/' . $mensalidade['cod_mensalidade'] ?>"> <i class="fa fa-trash"></i> Excluir</a> 
