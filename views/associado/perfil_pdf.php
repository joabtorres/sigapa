...
<html lang="pt-br">
    ...
    <body>
        ...
        <table class="table">
            ...
            <tr>
                <td rowspan="5"><img src="<?php echo!empty($cooperado['cooperado']['imagem']) ? BASE_URL . '/' . $cooperado['cooperado']['imagem'] : BASE_URL . '/assets/imagens/foto_ilustrato3x4.png' ?>" width="100px"/></td>
            </tr>
            <tr>
        ...
        <table class="table">
            <tr>
                <th colspan="4"><h4 class="text-destaque">Relatório de Produção</h4></th>
            </tr>
            <?php
